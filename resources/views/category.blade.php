                ...
                @foreach ($posts as $post)
                    <div class="item entry item-h2 photography print">
                        ...
                        <div data-href="{{ url('artist',$post->artistID) }}" class="hovereffect clickable-row">
                            <a data-gal="prettyPhoto[product-gallery]" rel="bookmark" href="data:image/png;base64,{{ chunk_split(base64_encode($post->post)) }}"><span artistID="{{$post->artistID}}" postID="{{$post->id}}" class="icon plus-icon-css"></span></a>
                            ...
                            <div>
                                <span  class="add_To_Cart" artistID="{{$post->artistID}}" postID="{{$post->id}}"><i class="fa fa-shopping-cart fa-2x"></i></span>
                            </div>
                        </div>
                    </div>
                @endforeach
